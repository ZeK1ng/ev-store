...
public class UserTokenAspect {
    ...
    public Object aroundMethodsForTokensForAdmin(final ProceedingJoinPoint pjp) throws Throwable {
    ...
    //TODO
//    @Around("")
    public Object aroundMethodsForTokensForUser(final ProceedingJoinPoint pjp) throws Throwable {
        final Object[] args = pjp.getArgs();
        final int n = args.length;
        String accessToken = (String) args[n - 2];
        final String refreshToken = (String) args[n - 1];
