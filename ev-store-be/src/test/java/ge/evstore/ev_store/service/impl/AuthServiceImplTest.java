...
class AuthServiceImplTest {
    ...
    void verifyOtp_ShouldReturnTrue_WhenOtpIsValid() {
        // Arrange
        final OtpVerificationRequest otpRequest = new OtpVerificationRequest("testUser@example.com", "123456");
        final User mockUser = new User();
    ...
    void verifyUser_ShouldThrowException_WhenVerificationCodeMismatch() {
        // Arrange
        final VerifyUserRequest verifyRequest = new VerifyUserRequest("testUser@example.com", "wrong-code");
        final User mockUser = new User();
