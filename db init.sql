...
ALTER TABLE "authTokens" ADD CONSTRAINT "refreshToken_user" FOREIGN KEY ("user") REFERENCES "users" ("id");

ALTER TABLE "users" ADD CONSTRAINT "favourites" FOREIGN KEY ("favouriteItems") REFERENCES "products" ("id");

ALTER TABLE "category" ADD CONSTRAINT "category_subCatergory" FOREIGN KEY ("parentCategoryId") REFERENCES "category" ("id");
